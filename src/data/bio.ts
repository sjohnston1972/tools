// Steven's bio — used by the chat system prompt. Keep this factual and tight;
...
- 2019–2024: Consultant Engineer, Ping Network Solutions. Multi-site BGP/IPsec → Cisco SD-WAN migration; CUCM → Microsoft Teams migration for ~2,000 users at a Scottish university; bespoke hosted management/monitoring platform across dual datacentres for an energy-sector client.
- 2015–2019: Principal Engineer, Virgin Media Business. LAN/WAN and DC redesign with Cisco Nexus 9K for the Scottish Courts Service. DC refresh with clustered Cisco UCS for the Scottish Prisons Service. Secure video conferencing for the Scottish Prisons Service.
- 2007–2015: Senior Network Engineer, Jabil. Led a European-wide LAN/WAN/Cisco telephony refresh across 112 sites. Two $3M datacentre builds in London and Budapest.
- 2003–2007: Network Engineer, Jabil.

Public sector clients (notable): Scottish Courts and Tribunals Service, Scottish Prisons Service, Crown Office.
...
- Security: Cisco/Palo Alto/Fortinet firewalls, Cisco ISE & Zero Trust, VPN & remote access, Umbrella & DUO, Cisco Secure Access / SASE.
- Cloud & Hybrid: Azure networking, transit hub design, hybrid connectivity, ExpressRoute, NVA firewalls (Cisco / Palo Alto), Azure Virtual WAN.
- Collaboration: Cisco Webex & MS Teams, SIP & CUBE, Cisco CUCM, enterprise voice.
